    ...
    <Router>
     ...
     <Switch>
      ...
      <Redirect to="/home" />
        ...
        <Route path="/home"><Home allPackages={this.props.allPackages} contactInfo={this.props.contactInfo} allTypes={this.props.allTypes} allProducts={this.props.allProducts} products={this.props.products} addProduct={this.props.addProduct} changeNote={this.props.changeNote}/></Route>
        ...
        <Route path="/menu"><Menu allCombos={this.props.allCombos} allPackages={this.props.allPackages} allTypes={this.props.allTypes} allProducts={this.props.allProducts} products={this.props.products} addProduct={this.props.addProduct}/></Route>
