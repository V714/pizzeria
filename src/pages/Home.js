  ...
  render() {
    ...
    return (
      <div>
          ...
          <Section4 allPackages={this.props.allPackages} allProducts={this.props.allProducts} products={this.props.products} addProduct={this.props.addProduct} changeNote={this.props.changeNote}/>
